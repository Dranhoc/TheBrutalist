      ...
      <div class="s-softskills__text-wrapper">
        <div class="text" ref="textRef" :style="{ transform: `translateX(${textOffset}px)` }">
          <span>
            ...
            COMPONENT RECYCLER · FONT SNOB (IN A GOOD WAY) · MARGIN TWEAKER · FIGMA TRANSLATOR · LOADING SPINNER PHILOSOPHER · EMPATHY-DRIVEN DESIGN · CURIOSITY OVERDRIVE · NAMING THING PHILOSOPHER · "IT WORKS ON MY MACHINE" DIPLOMAT
          </span>
        </div>
      </div>
    </div>
